...
{
    public class ModWukongCard : CardWukong, IModCard
    {
        public ModWukongCard() : base("Card/IDS_CARD_NAME_ZGTestCard", CombatAction.CombatActionType.SKILL, CombatAction.ActionTargetType.ALLY_ALL)
        {
            Rarity = Rarity.RARE;
